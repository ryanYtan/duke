# JavaFX Tutorial Part 2 - Creating a GUI for duke.ui.Duke

In this tutorial, we will be creating a GUI for duke.ui.Duke from scratch based on the following mockup.

![Mockup for duke.ui.Duke](assets/DukeMockup.png)
...
![duke.ui.Duke's layout](assets/DukeSceneGraph.png) 
...
![duke.ui.Duke's raw layout](assets/RawLayout.png)
...
![duke.ui.Duke's Final layout](assets/FinalLayout.png)
